...
use BuckhamDuffy\Expressions\Operator\Comparison\LessThan;
...
it('can compare two expressions by less than check')
    ->expect(new LessThan(new Expression(1), new Expression(2)))
